...
import br.com.maratonajava.lambdas.classes.ComparadorCarro;
...
public class LambdaTeste3 {
    public static void main(String[] args) {
        forEach(asList("Diego", "DevDojo", "facebook.com/devdojobr"), System.out::println);
        ...
        List<String> nomes = asList("Diego", "DevDojo", "Anna", "Brenon");
