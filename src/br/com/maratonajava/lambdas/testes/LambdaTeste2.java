...
public class LambdaTeste2 {
    public static void main(String[] args) {
        forEach(asList("Diego", "DevDojo", "facebook.com/devdojobr"), (String s) -> System.out.println(s));
        List<Integer> list = map(asList("Diego", "DevDojo", "facebook.com/devdojobr"), (String s) -> s.length());
